		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-right">
				<ul class="nav navbar-nav">
					...
					<li class="scroll"><a href="#about">科室</a></li>
					<li class="scroll"><a href="#services">项目</a></li>
					<li class="scroll"><a href="#pricing">套餐</a></li>
					<li class="scroll"><a href="#contact-us">登录</a></li>                        
				</ul>
			</div>
		</div><!--/.container-->
	</nav><!--/nav-->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="carousel-content">
								<h2><span>Pet Care</span> with Love</h2>
			...
			<div class="slider-inner">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<div class="carousel-content">
								<h2><span>24/7</span> Pets Care</h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
							</div>
						</div>
					</div>
...
<section id="hero-text" class="wow fadeIn">
	<div class="container">
		<div class="row">
			<div class="col-sm-9">
				<h2>Welcome to Pet Care Group</h2>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 wow fadeInRight">
				<h3 class="column-title">We Take Care Your Pets</h3>
			...
			<div class="features">
				...
				<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
					<div class="media service-box">
						...
						<div class="media-body">
							<h4 class="media-heading">Ultrasound</h4>
							<p>Morbi vitae tortor tempus, placerat leo et, suscipit lectus. Phasellus ut euismod massa, eu eleifend ipsum.</p>
						</div>
					</div>
				</div><!--/.col-md-4-->
...
<section id="pricing">
	<div class="container">
		<div class="section-header">
			<h2 class="section-title text-center wow fadeInDown">Fees</h2>
			<p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa <br> semper aliquam quis mattis quam.</p>
		</div>
...
<section id="our-team" class="section teams">
<div class="container">
<div class="section-header">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="col-sm-6">Copyright &copy; 2017.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></div>
			<div class="col-sm-6">
